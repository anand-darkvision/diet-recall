...
class EveningSnackPrediction extends StatefulWidget {
  const EveningSnackPrediction({Key? key}) : super(key: key);

  @override
  State<EveningSnackPrediction> createState() => _EveningSnackPredictionState();
}

class _EveningSnackPredictionState extends State<EveningSnackPrediction> {
  String servings = '';
  ...
  Widget build(BuildContext context) {
    ...
    var b4 = Snacks_dataset().getsnackcarbs();
    var b5 = Snacks_dataset().getsnackfats();
    ...
    void addFood(evening_Contact contact) {
      final contactBox = Hive.box('evening');
        ...
        leading: TextButton.icon(
            onPressed: () {
              Navigator.of(context).pushReplacement(
                  MaterialPageRoute(builder: (context) => const EveningView()));
            },
            icon: const Icon(
              Icons.arrow_back,
              color: Colors.black,
                  ...
                  ? [
                      ...
                      Material(
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () async {
                              Hive.openBox("recall");
                              final newContact = evening_Contact(
