...
class DinnerFoodPredicition extends StatefulWidget {
  const DinnerFoodPredicition({Key? key}) : super(key: key);

  @override
  State<DinnerFoodPredicition> createState() => _DinnerFoodPredicitionState();
}

class _DinnerFoodPredicitionState extends State<DinnerFoodPredicition> {
  String servings = '';
  // text var
  ...
  Widget build(BuildContext context) {
    ...
    var b1 = Dinners_dataset().getdinner();
    var b2 = Dinners_dataset().getdinnercal();
    var b3 = Dinners_dataset().getdinnerpro();
    var b4 = Dinners_dataset().getdinnercarbs();
    var b5 = Dinners_dataset().getdinnerfats();
    ...
    void addFood(Dinner_Contact contact) {
                  ...
                  ? [
                      ...
                      Material(
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () async {
                              Hive.openBox("recall");
                              final newContact = Dinner_Contact(
