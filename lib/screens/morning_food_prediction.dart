...
import 'package:dietrecallapp/Nutrition_screen/breakfast.dart';
...
class MorningFoodPrediction extends StatefulWidget {
  const MorningFoodPrediction({Key? key}) : super(key: key);

  @override
  State<MorningFoodPrediction> createState() => _MorningFoodPredictionState();
}

class _MorningFoodPredictionState extends State<MorningFoodPrediction> {
  String servings = '';
  ...
  Future loadModel() async {
    ...
    print("for breakfast Models loading status: $res");
  }
  ...
  Widget build(BuildContext context) {
    ...
    var b1 = BreakFast_dataset().getbreakfast();
    var b2 = BreakFast_dataset().getbreakfastcal();
    var b3 = BreakFast_dataset().getbreakfastpro();
    var b4 = BreakFast_dataset().getbreakfastcarb();
    var b5 = BreakFast_dataset().getbreakfastfat();
                        ...
                        child: MaterialButton(
                            ...
                            onPressed: () async {
                              ...
                              final newContact = Breakfast_Contact(
                                  ...
                                  (_serving.text.toString().contains('0'))
                                      ? int.parse('0')
