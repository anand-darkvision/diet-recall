...
import 'package:dietrecallapp/screens/evening_snack_prediction.dart';
...
class EveningMeal extends StatefulWidget {
  const EveningMeal({Key? key}) : super(key: key);

  @override
  State<EveningMeal> createState() => _EveningMealState();
}
...
class _EveningMealState extends State<EveningMeal> {
  @override
      ...
      child: MaterialButton(
          ...
          onPressed: () async {
            ...
            Navigator.of(context).pushReplacement(
                MaterialPageRoute(builder: (context) => const EveningMeal()));
          },
          child: Text(
            "${t?.addmo}",
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              Text(
                "${t?.whatdidyouaddforeveningsnacks}",
                style: const TextStyle(
                  fontWeight: FontWeight.bold,
                  fontSize: 18,
                ),
